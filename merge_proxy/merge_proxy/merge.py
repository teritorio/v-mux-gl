...
from .prometheus import merge_instruments as prometheus_merge_instruments
...
def merge_tile(
    ...
    with prometheus_summary_fetch_full[z].time():
    ...
    with prometheus_summary_fetch_partial[z].time():
